...
contains solved exercises and questions, but the reader is also given
230 problems to solve.\\

\noindent The aim of this book is to provide clear, logically consistent solutions
to all of the 230 unsolved problems addressed, written in a style accessible to
...
\begin{itemize}
  \item Part I - Chapter 2 - Problem 7
  \item Part I - Chapter 2 - Problem 8
\end{itemize}
...
\begin{problem} %4
$F$ and $G$ can be connected with a line since basis Axiom 1 of Projective Geometry we can construct a line.
This line intersects at a unique point $H$ with the line $e$. If $e$ was parallel to line $GF$ then they would never 
intersect. But given the visual in the problem we are assuming that they will intersect.

\begin{center}
\includegraphics[width=1\textwidth]{p1-c01-prob04.png}  
\end{center}
...
\begin{problem} %5
There are 8 angles in this. From one side of the ray of $b$ to one side of $a$ (via convex) and another via not the 
convex side. Similarly 2 ways to other side ray $a$. Then 4 more ways for the other side of ray $b$.

\begin{center}
\includegraphics[width=1\textwidth]{p1-c02-prob05.png}  
\end{center}
\end{problem}
...
\begin{quote}
  Two convex angles that have one side in common are positioned in such a way that the second side of one angle is an extension 
  of the second side of the other angle are called \emph{supplementary angles}.
\end{quote}
In schools we are usually taught that if the sum of two angles is $180 \degree$ they are called supplementary angles.\\
...
\begin{center}
\includegraphics[width=1\textwidth]{p1-c02-prob06.png}  
\end{center}
...
\begin{center}
\includegraphics[width=1\textwidth]{p1-c02-prob07.png}  
\end{center}
